...
Chat = {{
    ...
    (
        ...
        <div class="chat">
            ...
            <div class="input">
                <span class="text"><input id=#entry onnewline={_ -> broadcast()} placeholder="Your Message Here" /></span>
                <div class="button" onclick={_ -> broadcast()}><span class="inner">Post</span></>
            </div>
        </div>
    )
